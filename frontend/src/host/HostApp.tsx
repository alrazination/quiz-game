          ...
          <>
            ...
            <div className="podium">
              {top50.slice(0, 3).map((p) => (
                <div key={p.player_code} className={`podium-place podium-place--${p.rank}`}>
    ...
    <div>
      {props.preflight && status === 'WAITING' && (
        <div className="preflight-list" style={{ marginBottom: 16 }}>
          ...
          <div className="preflight-row"><span>Participants loaded</span><span className="preflight-ok">{props.preflight.details.participantsLoaded}</span></div>
